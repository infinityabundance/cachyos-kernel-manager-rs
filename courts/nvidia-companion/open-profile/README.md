# nvidia-companion/open-profile

Phase 5 transaction court on fixture `nvidia-open-profile`.
...
Expected pacman argv(s): 'pacman' '-S' '--needed' 'linux-cachyos-court2-nvidia-open' 'linux-cachyos-court2' 'linux-cachyos-court2-headers'

Run: `cargo xtask court run nvidia-companion/open-profile --vm`
