# nvidia-companion/modules-installed

Phase 5 transaction court on fixture `nvidia-modules-installed`.
...
Run: `cargo xtask court run nvidia-companion/modules-installed --vm`
