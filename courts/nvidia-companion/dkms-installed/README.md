# nvidia-companion/dkms-installed

Phase 5 transaction court on fixture `nvidia-dkms-installed`.
...
Expected pacman argv(s): 'pacman' '-S' '--needed' 'linux-cachyos-court2' 'linux-cachyos-court2-headers'

Run: `cargo xtask court run nvidia-companion/dkms-installed --vm`
